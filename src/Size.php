...
class Size
{
    ...
    public function fit(Size $size, $position = 'center')
    {
        ...
        $auto_height->resizeOldImage($this->width, null, function ($constraint) {
        ...
        if ($auto_height->fitsInto($this)) {
            ...
            $auto_width->resizeOldImage(null, $this->height, function ($constraint) {
                $constraint->aspectRatio();
            });
     ...
     * @return Size
     */
    public function resizeOldImage($width, $height, ?Closure $callback = null)
    {
